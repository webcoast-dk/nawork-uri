...
define('TYPO3_MOD_PATH', '../typo3conf/ext/nawork_uri/Modules/Redirects/');
$BACK_PATH='../../../../typo3/';
$MCONF['name']='txnaworkuriUrls';

$MCONF['access']='user,group';
$MLANG['default']['tabs_images']['tab'] = 'moduleicon.png';
$MLANG['default']['ll_ref']='LLL:EXT:nawork_uri/Resources/Language/locallang_mod_redirects.xml';
