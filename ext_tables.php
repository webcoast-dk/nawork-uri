...
if (defined('TYPO3_MODE') && TYPO3_MODE == 'BE') {
    ...
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update'][Nawork\NaworkUri\Install\UpdateCacheHashWizard::class] = Nawork\NaworkUri\Install\UpdateCacheHashWizard::class;
}
